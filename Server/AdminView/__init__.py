...
from .RoleAdminView import RoleAdminView
...
admin.add_view(RoleAdminView(Type, db.session, name="Тип услуги"))
admin.add_view(RoleAdminView(StateOrder, db.session, name="Состояние заказа"))
